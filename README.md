...
│   ├── gemini-cli/
│   └── ... (3 more)
├── skills/                      # reusable skill definitions (15)
│   ├── ai-daily-news/
│   ├── deepin-dev/
│   ├── deepin-requirement-crawler/
│   └── ... (12 more)
├── scripts/                     # shared executable tools (11)
│   ├── analyze-7day-vs-benchmark/
│   ├── analyze-morning-current/
│   ├── bootstrap/
│   └── ... (8 more)
├── wrappers/                    # controlled CLI wrappers (1)
│   └── opencode-review/
├── addons/                      # installable upstream enhancements (9)
│   ├── cc-switch/
│   ├── context-mode/
│   ├── gh-cli/
│   └── ... (6 more)
├── packs/                       # composed bundles for roles and workflows (9)
│   ├── agent-baseline.json
│   ├── agent-references.json
│   ├── ai-daily-news-workflow.json
│   └── ... (6 more)
├── references/                  # discoverable external references (9)
│   ├── agent-skills/
